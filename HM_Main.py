 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "from timm.models.sknet import HVT50_32x4d\n",
    "\n",
    "from model.op.TripletOp import TripletOp"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "alldatapath = '/home/anusha/hm/data_dev.jsonl'\n",
 "alldatapath = '/home/anusha/hm/data_train.jsonl'\n",
 "alldatapath = '/home/anusha/hm/data_test.jsonl'\n",
    "allcaptionvectorspath = '/home/anusha/hm,allcaptionvectors.pt'\n",
   ]
  },
  {
   "cell_type": "code",
